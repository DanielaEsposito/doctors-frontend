...
const RegistrationForm = () => {
  ...
  const checkEmailExists = (email, callback) => {
    fetch(`http://localhost:3000/check-email?email=${email}`)
      ...
      .then((data) => {
        callback(data.exists), setLoader(false);
      });
  };
              ...
              <div className="container">
                <ul className="list-unstyled">
                  <li className="d-flex fs-5 align-items-center mb-3">
                    ...
                    Entra a far parte di una vasta comunità di professionisti
                    della salute.
                  </li>
                  <li className="d-flex fs-5 align-items-center mb-3">
                    <i className="fa-solid fa-star text-warning me-2"></i>
                  ...
                  <li className="d-flex fs-5 align-items-center mb-3">
                    <i className="fa-solid fa-star text-warning me-2"></i>
                    Crea un profilo distintivo e fai emergere le tue competenze
                    tra i medici della tua zona.
                  </li>
                </ul>
              </div>
            </div>
